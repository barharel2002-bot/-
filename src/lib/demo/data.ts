...
// ===== Copy output (YouTube Description Writer) =====
export const DEMO_COPY_OUTPUT: CopyOutput = {
  description: `אם הייתי יודע את זה כשהתחלתי ב-YouTube — הייתי חוסך לעצמי 200 שעות מבוזבזות.

בסרטון הזה אני עובר על 3 דברים שאף אחד לא הסביר לי ביוצר תוכן בשנה הראשונה. דברים שלמדתי רק אחרי שכמעט פרשתי.

מה תקבל בסרטון:
00:00 - הקדמה: למה רוב היוצרים פורשים בשנה הראשונה
01:30 - טעות 1: לדבר ל"כולם" במקום למישהו אחד
04:15 - טעות 2: לחכות לוידאו "מושלם"
07:40 - טעות 3: להסתכל על מספרים במקום על אדם אחד
10:20 - מה הייתי עושה היום אם הייתי מתחיל מחדש

אם אתה יוצר תוכן בתחילת הדרך — הסרטון הזה בשבילך.

🎯 אהבת את הסרטון? הצטרף לערוץ למעלה — אני מעלה תוכן חדש כל שבוע על איך לבנות קהל אמיתי ב-YouTube.

📌 קישורים שהוזכרו: (תוסיף את הקישורים שלך כאן)
📩 לעבודה איתי: (אימייל / לינק)
🐦 טוויטר: (handle)`,
  hooks: [
    'אם הייתי יודע את זה כשהתחלתי ב-YouTube — הייתי חוסך 200 שעות',
    '3 טעויות שאף אחד לא יגיד ליוצר תוכן בשנה הראשונה. מי שיתקן אחת מהן יקפוץ קדימה.',
    'תוכן טוב לא מתפוצץ ב-YouTube. גיליתי למה — וזה לא מה שחשבתי.',
  ],
  tags: [
    'youtube tips',
    'content creation',
  ...
  pinnedComment:
    'איזו מ-3 הטעויות עשית? תכתוב בתגובה את המספר — מסקרן אותי לראות מה הכי נפוץ 👇',
};
